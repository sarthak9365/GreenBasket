...
public class MainActivity<gt, lt, pss> extends AppCompatActivity {
    ...
    private ImageButton imageButtonBack,imageButtonForward;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // imageButtonBack=(ImageButton)findViewById(R.id.imageButtonBack_1);
        // imageButtonForward=(ImageButton)findViewById(R.id.imageButtonForward_1);
